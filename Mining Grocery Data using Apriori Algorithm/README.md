...
Given the lift values of the transactions we can recommend the retailer to cross sell or place root vegetables with other vagetables,thus we can recommend root vegetables when beef,other vegetables are also purchased.
